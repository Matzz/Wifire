...
SessionsConfigProvider::SessionsConfigProvider(String fileName, ConfigProvider<UsersConfig>& usersProvider) :
    FileConfigProvider(fileName),
    usersProvider(usersProvider) {}

Either<String, Vector<Session>> SessionsConfigProvider::load() {
